    ...
    public static void main(String[] args) {
        try {
            ...
            String str1[] = {"78", "23", "-91", "99", "-24", "-788",
                ...
                "154352", "1", "13315", "090090", "010", "12532", "7700"};
            String str2[] = {"675", "-9", "1352", "-0975", "4", "1", 
                ...
                "124", "-3246357464", "123524", "-123523", "153", "-987218545", "90"};
            ...
            for (int i=0; i<numeri; i++) {
                ...
                if (big1[i].equals(new BigInteger("0")) || big2[i].equals(new BigInteger("0"))) {
                    ...
                    s2[i] = bug1[i].divide(bug2[i]).toString();
            }
            ...
            for (int i=0; i<numeri; i++) {
                ...
                if (big1[i].equals(new BigInteger("0")) || big2[i].equals(new BigInteger("0"))) {
                    ...
                    s2[i] = bug1[i].remainder(bug2[i]).toString();
